# File used by centralized search algorithm to initially parition the area
# into 'N' equally divided sub-areas. N here is the number of robots. 
...
'''
For testing and visualization uncomment below lines
'''
