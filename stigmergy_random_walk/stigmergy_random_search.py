...
def run_headless_random_walk(
    ...
    """
    Run stigmergy random walk without live animation.
    """
...
if __name__ == "__main__":
    ...
    if VISUALIZATION_MODE in ["none", "final"]:
        ...
        world_pher_img = ax_world.imshow(
