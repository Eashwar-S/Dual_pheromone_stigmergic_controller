...
@dataclass
class Robot:
    """Search robot with sign-flipped pheromone preference."""
    ...
    _recent_search_positions: Deque[Tuple[int, int]] = field(
    ...
    def choose_move_search(
        ...
        """Prefer higher pheromone instead of lower pheromone."""
        ...
        for dx, dy in actions:
            ...
            candidates.append({
                ...
                "momentum": 0 if self._last_move == (dx, dy) else 1,
        ...
        non_recent = [
            candidate
            for candidate in candidates
            if candidate["waypoint"] not in self._recent_search_positions
        ]
        if non_recent:
    ...
    def record_waypoint(
        ...
        self._recent_search_positions.append(waypoint)
